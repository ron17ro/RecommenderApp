...
def get_nearby_places(coordinates, place_type, next_page):
	URL = ('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='
		+coordinates+'&radius=5000&key='+ api_key +'&type='
		+place_type+'&pagetoken='+next_page)
	r = requests.get(URL)
	response = r.text
	...
	for result in results:
		...
		print([place_type, place_name, website])
		total_results.append([place_type, place_name, website])
	try:
